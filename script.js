...
btnClear.addEventListener('click',function() {
  inputs.forEach(input => input.value=' ');
    ...
    let arrayPessoas=[]
      ...
      var pessoa = {nome: nome, cpfcnpj: cpfcnpj, telefone: telefone, email: email, cep: cep,logradouro:logradouro,numero:numero,bairro:bairro,estado:estado};
...
localStorage.setItem("pessoas", pessoaJson);
  ...
  lnome =localStorage.getItem("name")
